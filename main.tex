...
\title{Graph Neural Networks for Astrophysics and Cosmology}
% Use \titlerunning{Short Title} for an abbreviated version of
% your contribution title if the original one is too long
\author{Christian Kragh Jespersen}
% Use \authorrunning{Short Title} for an abbreviated version of
% your contribution title if the original one is too long
\institute{First Author (\Letter) \at Department of Astrophysical Sciences, Princeton University, \email{ckragh@princeton.edu}}
%
...
\cite{2022MLS&T...3a5023W}

% \LaTeX{} \cite{latex2e} is a set of macros built atop \TeX{} \cite{unsrt}.
